...
""",
"threat_analysis": """
- Detailed examination of each threat category
- For each threat type: description, mechanisms, impact
- Include formalizations/mathematical models where applicable
- Explain why these threats emerge (e.g., architectural vulnerabilities)
- Reference real-world examples or prior attacks if available
""",
    "case_studies": """
- Concrete examples demonstrating the threats
- Description of experimental or observational setups
- Important parameters or conditions for the cases
- Implementation details if discussing attack methods
- Metrics for evaluating threat severity/impact
""",
    "experimental setup": """
...
- Current approaches to address each threat
- Compare defense mechanisms
- Evaluate effectiveness of different strategies
- Discuss limitations of existing mitigations
""",
    "discussion": """
...
- Final thoughts on state of AI brain safety
- Most pressing open challenges
...
class PaperSolver:
    ...
    def gen_initial_report(self):
        ...
        for _section in ["scaffold", "abstract", "introduction", "related work", "background","threat_analysis","case_studies","mitigation_strategies", "methods", "experimental setup", "results","conclusion"]:
...
\\end{figure}\n"""
        ...
        if paper_len < 5000: paper_progress = f"The current length of the paper is {paper_len} words, you must increase this by {5000-paper_len} words."
        else: paper_progress = ""
